...
async function groupEvents(conn, update) {
    ...
    const isWelcomeEnabled = (userConfig.WELCOME || userConfig.WELCOME_ENABLE || config.WELCOME || config.WELCOME_ENABLE) === 'true';
    const isGoodbyeEnabled = (userConfig.GOODBYE || userConfig.GOODBYE_ENABLE || config.GOODBYE || config.GOODBYE_ENABLE) === 'true';
...
*╰────────────────────○*`;
                ...
                const welcomeText = userConfig.WELCOME_MSG || config.WELCOME_MSG || defaultWelcomeMsg;
...
*╰────────────────────○*`;
                ...
                const goodbyeText = userConfig.GOODBYE_MSG || config.GOODBYE_MSG || defaultGoodbyeMsg;
