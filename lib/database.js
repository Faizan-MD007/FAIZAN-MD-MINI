...
const userConfigSchema = new mongoose.Schema({
    ...
    config: {
        ...
        ANTI_LINK: { type: String, default: 'true' },
        ANTI_DELETE: { type: String, default: 'true' },
        ANTI_BAD: { type: String, default: 'true' },
        ANTI_VIEW_ONCE: { type: String, default: 'true' },
        AUTO_REACT_EMOJI: { type: Array, default: ['👀', '🫀', '🧡', '❤️‍🩹', '❣️', '💖', '💝', '🦋', '😘', '🤍', '🥰', '🌝', '💨', '🌟', '✨', '🫦', '💐', '🌺', '🪷', '🍄', '🍁', '🪴', '🥀', '🌈', '🌒', '🌓', '🌔', '🌕', '🌖', '🌗', '🌘', '🌑', '🪽', '🍒', '🍇', '🥖', '🥢', '🛟', '🎀', '🎗️', '🎈', '🎱', '🪀', '🪄', '🪡', '🧷', '🧣', '💍', '🧸', '🔗', '🖇️', '🗞️', '📅', '🔮', '♏', '🇰🇼', '🏳️'] },
        WELCOME_MSG: { type: String, default: '' },
        GOODBYE_MSG: { type: String, default: '' },
        ANTI_EDIT: { type: String, default: 'true' }
    },
    createdAt: { type: Date, default: Date.now },
    updatedAt: { type: Date, default: Date.now }
});
