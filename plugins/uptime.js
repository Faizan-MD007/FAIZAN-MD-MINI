...
cmd({
    ...
    try {
        ...
        // Run for 30 seconds, live-editing the same message every second
        for (let i = 0; i < 30; i++) {
...
*│ ╌─̇─̣⊰ ${config.OWNER_NAME || '𝐅αɪᴢαɴ-𝐌ᴅ'} ⊱┈─̇─̣╌*
*│─̇─̣┄┄┄┄┄┄┄┄┄┄┄┄┄─̇─̣*
*│❀ ⏱️ 𝐔𝐩𝐭𝐢𝐦𝐞:* ${up}
*│❀ 🤖 𝐁𝐨𝐭:* ${config.BOT_NAME}
*│❀ 👑 𝐎𝐰𝐧𝐞𝐫:* ${config.OWNER_NAME}
*│❀ ⚙️ 𝐌𝐨𝐝𝐞:* ${config.WORK_TYPE}
*╰┄─̣┄─̇─̣┄─̇─̣┄─̇─̣┄─̇─̣─̇─̣─᛭*

> ${config.DESCRIPTION || config.BOT_FOOTER}
`;
